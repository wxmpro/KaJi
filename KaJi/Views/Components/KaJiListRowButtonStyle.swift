...
//  - 颜色过渡走 KaJiAnimation.editorModeSwitch，保证侧栏与列表动效一致。
//
...
struct KaJiListRowButtonStyle: ButtonStyle {
    ...
    func makeBody(configuration: Configuration) -> some View {
        configuration.label
            ...
            .animation(KaJiAnimation.editorModeSwitch, value: configuration.isPressed)
            .animation(KaJiAnimation.editorModeSwitch, value: isSelected)
    }
